...
The dashboard reads consolidated Parquet files produced by the ETL pipeline. Each file is one stratum level, covering all months. The authoritative spec is [`docs/TRACKER.md`](https://github.com/).
